...
fn main() {
    ...
    c.e(
        0.1,
        "  2) Full  \u{2014} provider, model, and platform adapters\r\n",
    );
    ...
    c.e(
        0.1,
        "  2) openrouter  \u{2014} 200+ hosted models (openrouter.ai)\r\n",
    );
    c.e(0.1, "  3) anthropic   \u{2014} Claude directly\r\n");
    c.e(0.1, "  4) vllm        \u{2014} self-hosted vLLM server\r\n");
    c.e(
        0.1,
        "  5) custom      \u{2014} any OpenAI-compatible endpoint\r\n",
    );
    ...
    c.e(
        0.3,
        &format!("  OLLAMA_BASE_URL {dim}[http://localhost:11434]{reset}: "),
    );
    c.e(0.5, "\r\n\r\n");
    ...
    c.e(
        0.5,
        &format!("Configuration saved to {dim}/Users/demo/.garudust{reset}\r\n\r\n"),
    );
    c.e(
        0.2,
        &format!("{green}\u{2713}{reset} Ollama reachable at http://localhost:11434\r\n"),
    );
    c.e(
        0.2,
        &format!("{green}\u{2713}{reset} Model llama3.2 available\r\n"),
    );
    ...
    c.e(
        0.2,
        &format!("  {cyan}let reversed: String = s.chars().rev().collect();{reset}\r\n\r\n"),
    );
    c.e(
        0.3,
        "For ASCII-only, `s.bytes().rev()` is slightly faster.\r\n",
    );
    ...
    c.e(
        0.5,
        &format!(
            "{green}Garudust{reset}  Rust achieves memory safety through three mechanisms:\r\n\r\n"
        ),
    );
    ...
    c.e(
        0.3,
        "Result: no use-after-free, no data races, zero runtime cost.\r\n",
    );
    ...
    c.e(
        0.5,
        &format!("{green}Garudust{reset}  High-level code blooms \u{2014}\r\n"),
    );
    ...
    eprintln!(
        "wrote {n} events \u{2192} {}  ({duration:.1}s)",
        out_path.display()
    );
}
